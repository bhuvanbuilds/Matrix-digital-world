      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <a href="#" className="text-2xl font-bold font-heading text-white tracking-wide block mb-6">
              Matrix
              <span className="text-primary font-bold"> Digital </span>
              World
            </a>
            <p className="text-gray-400 leading-relaxed mb-6">
              Transforming visions into digital realities. We are a full-service agency dedicated to your growth.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-[#E1306C] hover:text-white transition-all">
                <Camera size={18} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['SEO & SEM', 'Social Media', 'Performance Marketing', 'Web Development', 'Video & Motion', 'Brand Identity'].map((item, i) => (
                <li key={i}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['About Us', 'Careers', 'Our Blueprint', 'Case Studies', 'Pricing', 'Contact'].map((item, i) => (
                <li key={i}>
                  <a href="#" className="text-gray-400 hover:text-primary transition-colors">{item}</a>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to get the latest digital trends.</p>
            <div className="relative">
              <input type="email" placeholder="Email address" className="w-full bg-white/5 border border-white/10 rounded-full pl-5 pr-32 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-primary" />
              <button className="absolute right-1 top-1 bottom-1 bg-primary text-white px-6 rounded-full font-semibold hover:bg-opacity-90 transition-all">
                Subscribe
              </button>
            </div>
          </div>
